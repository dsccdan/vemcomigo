...
export const RidesProvider = ({ children }) => {
  ...
  const [rides, setRides] = useState([
    { id: '1', driver: 'João', destination: 'Centro da Cidade', time: '09:00', date: '2022-10-28', spots: 0, imageUrl: 'https://via.placeholder.com/80' },
    { id: '2', driver: 'Maria', destination: 'Shopping Metropolitano', time: '13:30', date: '2022-10-29', spots: 3, imageUrl: 'https://via.placeholder.com/80' },
